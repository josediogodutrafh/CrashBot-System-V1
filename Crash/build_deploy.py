...
def create_github_release(version_str):
    ...
    print()
    print("=" * 70)
    print("  INSTRUCOES PARA GITHUB RELEASE")
    print("=" * 70)
    print()
    print(f"1. Acesse: https://github.com/SEU_USUARIO/SEU_REPO/releases/new")
    print()
    print(f"2. Selecione a tag: v{version_str}")
    print()
    print(f"3. Titulo: TucunareBot v{version_str}")
    print()
    print(f"4. Anexe o arquivo:")
    print(f"   {exe_path}")
    print()
    print(f"5. Cole o conteudo de:")
    print(f"   {DIST_DIR / f'RELEASE_NOTES_v{version_str}.md'}")
    print()
    print("=" * 70)
...
def main():
    print()
    print("=" * 70)
    print("  TUCUNAREBOT - BUILD & DEPLOY SYSTEM")
    print("=" * 70)
    print()
    ...
    print()
    print("=" * 70)
    print(f"  BUILD CONCLUIDO - v{version_str}")
    print("=" * 70)
    print()
