"""
Parser 7Bra - Adaptador de protocolo WebSocket para plataforma 7BraCasino.
...
class SevenBraParser(BrabetParser):
    """Parser 7Bra — herda protocolo Brabet (mesmo motor de jogo)."""
